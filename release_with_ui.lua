--[[
RTaO Dev Fluent UI Version 0.1
...
--[[ === RTaO UI Modifier Injected === ]]--

-- ✅ วางไว้หลังจาก Window ถูกสร้างแล้ว
-- สมมุติว่า Window = Fluent:CreateWindow({...})
...
-- ✅ ย้าย UI ไปมุมซ้ายบน
Window.WindowFrame.Position = UDim2.new(0, 70, 0, 70)
...
Window.WindowFrame.InputBegan:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 then
		...
		startPos = Window.WindowFrame.Position
...
Window.WindowFrame.InputChanged:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseMovement then
		dragInput = input
	end
end)
...
UIS.InputChanged:Connect(function(input)
	if input == dragInput and dragging then
		...
		Window.WindowFrame.Position = UDim2.new(
...
-- ✅ ปุ่ม Toggle UI พร้อมเปลี่ยนรูป
local ToggleButton = Instance.new("ImageButton")
ToggleButton.Name = "RTaO_Toggle"
ToggleButton.Image = "rbxassetid://131412349284393"
ToggleButton.Size = UDim2.new(0, 45, 0, 45)
ToggleButton.Position = UDim2.new(0, 10, 0, 10)
ToggleButton.BackgroundTransparency = 1
ToggleButton.Parent = PlayerGui:FindFirstChild("ScreenGui") or PlayerGui:FindFirstChildOfClass("ScreenGui")

local visible = true
ToggleButton.MouseButton1Click:Connect(function()
	visible = not Window.WindowFrame.Visible
	Window.WindowFrame.Visible = visible
end)
ayerGui")
