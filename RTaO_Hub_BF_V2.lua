...
v0.new("<Color=Cyan>Welcome to RTaO Hub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(114547910020827) ;
...
v8.Image = "rbxassetid://131242779197620";
v8.Draggable = true;
