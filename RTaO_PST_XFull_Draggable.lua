...
shared.LoaderTitle = "Credits: RTaO";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://131412349284393",
...
-- 🔘 ปุ่มเปิด/ปิด UI (ลากได้ + เปลี่ยนรูปได้)
local FluentToggleGui = Instance.new("ScreenGui")
FluentToggleGui.Name = "FluentDraggableToggle"
FluentToggleGui.ResetOnSpawn = false
FluentToggleGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
FluentToggleGui.Parent = game:GetService("CoreGui")
