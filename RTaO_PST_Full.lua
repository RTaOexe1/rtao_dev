local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/RTaOexe1/rtao_dev/refs/heads/main/release_with_ui.lua"))()
...
local Window = Fluent:CreateWindow({
    Title = "RTaO Dev |  ",
    SubTitle = "Prospecting! Version 0.1 Beta",
    TabWidth = 160,
