...
v0.new("<Color=Cyan>Welcome to Beru Hub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(129912758563771) ;
...
v8.Image = "rbxassetid://129912758563771";
v8.Draggable = true;
